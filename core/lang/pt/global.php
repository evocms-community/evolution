...
$_lang["configcheck_cache_msg"] = 'O sistema EVO não pode escrever o directório de cache. O sistema EVO continuará a funcionar como esperado, mas a cache não estará activa. Para resolver isto, active a permissão de escrita no directório da cache (/_cache/).';
...
$_lang["search_results_returned_msg"] = 'Os critérios da sua procura retornaram <b>%s</b> documentos. Se estiver a obter demasiados resultados, tente indicar uma procura mais específica.';
