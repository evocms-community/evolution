...
$_lang["configcheck_cache_msg"] = 'EVO לא יכול לכתוב לתיקיית זיכרון  המטמון .  EVO  ימשיך לתפקד כמצופה, אך לא ניתן יהיה להשתמש בזיכרון מטמון.  כדי לפתור את זה, יש לתת לתיקיית / _cache /   הרשאות כתיבה.';
