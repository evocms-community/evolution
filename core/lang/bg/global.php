...
$_lang["configcheck_cache_msg"] = 'EVO не може да пише в кеш-директорията. EVO ще работи нормално, но няма да се извършва кеширане. За да разрешите проблема, позволете записа в директория /_cache/ .';
