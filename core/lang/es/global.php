...
$_lang["about_msg"] = 'Evolution CMS es <a href="https://evo-cms.com/" target="_blank">un marco de aplicación PHP y un sistema de gestión de contenido</a> con licencia <a href="https://www.gnu.org/licenses/gpl-3.0.html">GNU GPL</a>.';
$_lang["about_title"] = 'Sobre el Evolution CMS';
$_lang["access_permission_denied"] = 'No tiene usted unos permisos correctos para este recurso.';
$_lang["access_permission_parent_denied"] = '¡No tiene el permiso para crear o mover el recurso aquí! Por favor elija otra ubicación.';
$_lang["access_permissions"] = 'Los permisos de acceso';
$_lang["access_permissions_add_resource_group"] = 'Crear un grupo de recursos nuevo';
$_lang["access_permissions_add_user_group"] = 'Crear un grupo nuevo de usuarios';
...
Para enlazar un grupo de recursos a un grupo de usuarios, seleccione usted los grupos apropriados del menú desplegable y haga usted clic en "Enviar".
...
$_lang["access_permissions_resource_groups"] = 'Los grupos de recursos';
$_lang["access_permissions_resources_in_group"] = '<b>Los recursos en el grupo:</b> ';
$_lang["access_permissions_resources_tab"] = 'Vea que grupos de recursos se han creado. También cree los grupos nuevos, cambie usted los nombres de los grupos, elimine usted los grupos y vea usted que recursos están en los diferentes grupos (pase usted el cursor sobre la ID del recurso para ver su nombre).
Para añadir un documento a un grupo o removerlo edite el recurso directamente.';
$_lang["access_permissions_user_groups"] = 'Los grupos de usuarios';
$_lang["access_permissions_user_message"] = 'Seleccione a que grupos de usuarios pertenece este usuario:';
$_lang["access_permissions_users_in_group"] = 'Los usuarios en el grupo:';
...
Para añadir un usuario nuevo a un grupo o removerlo, edite usted el usuario directamente. Los administradores (usuarios a los que se les ha asignado el rol con ID 1) siempre tienen acceso a todos los recursos por lo que no necesitan ser añadidos a ningún grupo.';
$_lang["account_email"] = 'El correo electrónico de cuenta';
...
$_lang["add_folder"] = 'Una carpeta nueva';
$_lang["add_plugin"] = 'Añadir una extensión (plugin)';
$_lang["add_resource"] = 'Un recurso nuevo';
...
$_lang["allow_mgr_access"] = 'El acceso al interfase de administrador';
$_lang["allow_mgr_access_message"] = 'Seleccione esta opción para habilitar o deshabilitar el acceso a la interfase de administrador.
<b>Nota: Si esta opción esta configurada como NO el usuario será redirigido a la página de ingreso de administrador o al Inicio de sitio.</b>';
$_lang["already_deleted"] = 'ha sido borrado ya.';
$_lang["attachment"] = 'El adjunto';
$_lang["author_infos"] = 'La información del autor';
...
$_lang["backup"] = 'La copia de seguridad';
$_lang["bk_manager"] = 'La copia de seguridad';
...
$_lang["blocked_minutes_title"] = 'Los minutos de bloqueo:';
$_lang["cache_files_deleted"] = 'Los siguientes archivos fueron borrados:';
$_lang["cancel"] = 'Cancelar';
$_lang["captcha_code"] = 'El código de seguridad';
...
$_lang["captcha_words_title"] = 'Las palabras de CAPTCHA';
$_lang["category_heading"] = 'La categoría';
$_lang["category_manager"] = 'El administrador de categorías';
$_lang["category_management"] = 'La gestión para las categorías';
$_lang["manage_categories"] = 'Gestionar las categorías';
$_lang["category_msg"] = 'Aquí puede usted ver y editar todos los elementos agrupados por categoría.';
...
$_lang["change_password_message"] = 'Por favor, ingrese su contraseña nueva y después confirmarla. Su contraseña debe tener entre 6 y 15 caracteres.';
...
$_lang["chunk"] = 'El trozo (chunk)';
$_lang["chunk_code"] = 'El texto de trozo (chunk) (html)';
$_lang["chunk_multiple_id"] = 'Error: los trozos (chunk) varios comparten la misma ID.';
$_lang["chunk_no_exist"] = 'El trozo (chunk) no existe.';
...
$_lang["close"] = 'Cerrar';
$_lang["code"] = 'El código';
$_lang["collapse_tree"] = 'Colapsar el árbol';
$_lang["comment"] = 'El comentario';
...
$_lang["configcheck_php_gdzip"] = 'El GD y/o Zip PHP extenciones no son encontrados.';
...
$_lang["configcheck_rb_base_dir"] = 'El estado de la dirección <a href="index.php?a=17&tab=6">Base de Files</a> parece incorrecto.';
...
$_lang["configcheck_unauthorizedpage_unpublished_msg"] = 'Esto significa que la página "No Autorizado" no está accesible para el público en general. Publique la página o asegúrese que está asignada a un documento existente en el árbol del sitio en el menu Herramientas &gt; Configuración.';
...
$_lang["confirm_publish"] = 'La publicación de este recurso removerá cualquier fecha de la (des)publicación que haya sido configurada. Si desea configurar o mantener las fechas de la (des)publicación, seleccione "Editar el recurso" en vez de publicar. ¿Continuar publicación?';
$_lang["confirm_remove_locks"] = 'Los usuarios a veces cierran sus navegadores mientras editan recursos, plantillas, fragmentos (snippets) o parsers, posiblemente dejando el artículo que estaban editando en estado cerrado. Al presionar OK puede remover TODOS los estados cerrados que están configurados actualmente. ¿Continuar?';
...
$_lang["confirm_setting_language_change"] = 'Ha modificado el valor prefijado y perderá los cambios. ¿Proceder?';
...
$_lang["confirm_unpublish"] = 'La despublicación de este recurso removerá cualquier fecha de (des)publicación que haya sido configurada. Si desea configurar o mantener las fechas de (des)publicación, por favor elige usted "Editar el recurso". ¿Continuar?';
...
$_lang["create_resource_title"] = 'Crear el recurso';
$_lang["create_weblink_here"] = 'Crear la enlace web aquí';
$_lang["createdon"] = 'La fecha de creación';
$_lang["create_new"] = 'Crear nuevo';
$_lang["credits"] = 'Los créditos';
...
$_lang["database_table_datasize"] = 'El tamaño de datos';
$_lang["database_table_droptablestatements"] = 'Generar los ordenes de DROP TABLE.';
$_lang["database_table_effectivesize"] = 'El tamaño efectivo';
$_lang["database_table_indexsize"] = 'El tamaño indexado';
$_lang["database_table_overhead"] = 'La sobrecarga';
$_lang["database_table_records"] = 'Los registros';
$_lang["database_table_tablename"] = 'El nombre de la tabla';
$_lang["database_table_totals"] = 'Totales:';
$_lang["database_table_totalsize"] = 'El tamaño total';
$_lang["database_tables"] = 'Las tablas de la dase de datos';
$_lang["database_version"] = 'La versión de la base de datos';
$_lang["date"] = 'La fecha';
$_lang["datechanged"] = 'La fecha de cambio';
$_lang["datepicker_offset"] = 'El desplazamiento del selector de fecha: ';
$_lang["datepicker_offset_message"] = 'El número de años para mostrar en el pasado en el selector de fecha.';
$_lang["datetime_format"] = 'El formato de fecha';
$_lang["datetime_format_message"] = 'El formato de fecha para usar en el administrador';
...
$_lang["defaulttemplate_title"] = 'La plantilla (template) por el defecto';
$_lang["defaulttemplate_logic_title"] = 'La asignación automática de plantillas';
$_lang["defaulttemplate_logic_general_message"] = 'Los nuevos recursos tendrán las plantillas siguientes, retrocediendo a los niveles más altos si no se encuentran:';
...
$_lang["description"] = 'La descripción';
...
$_lang["documentation"] = 'La documentatión';
...
$_lang["edit_settings"] = 'La configuración';
$_lang["editedon"] = 'La fecha de edición';
...
$_lang["editor_css_path_title"] = 'La dirección del archivo CSS:';
$_lang["element"] = 'El elemento';
$_lang["element_categories"] = 'La vista combinada';
...
$_lang["element_selector_title"] = 'El selector de elemento';
$_lang["elements"] = 'Los elementos';
$_lang["email"] = 'El correo electrónico';
$_lang["email_sent"] = 'El correo electrónico fue enviado';
$_lang["email_unique"] = 'El correo eléctronico está en uso ya';
$_lang["emailsender_message"] = 'La dirección de correo electrónico del administrador de sitio. Por ejemplo, esta dirección de correo electrónico se utilizará como destino del correo electrónico de notificación del sistema, etc.';
$_lang["emailsender_title"] = 'La dirección de correo electrónico:';
...
$_lang["emailsubject_title"] = 'El asunto del correo electrónico:';
...
$_lang["error"] = 'El error';
$_lang["error_sending_email"] = 'El error enviando correo electrónico';
...
<b>Nota: asegúrese que este ID pertenece a un recurso existente y ¡que ha sido publicado!</b>';
$_lang["errorpage_title"] = 'La página de error:';
$_lang["event_id"] = 'ID de evento';
$_lang["eventlog"] = 'El archivo de registros';
...
$_lang["eventlog_viewer"] = 'Los eventos de sistema';
$_lang["everybody"] = 'Toda la gente';
$_lang["existing_category"] = 'La categoría existente';
...
$_lang["failed_login_title"] = 'Los intentos de ingreso fallidos:';
$_lang["fe_editor_lang_message"] = 'Seleccione el idioma para el editor, para cuando sea usado como editor frontal.';
$_lang["fe_editor_lang_title"] = 'El idioma de editor frontal:';
...
$_lang["filemanager_path_title"] = 'La dirección del administrador de archivos:';
$_lang["files_access_denied"] = '¡El acceso fue denegado!';
$_lang["files_data"] = 'Los datos';
$_lang["files_dir_listing"] = 'La lista de directorio para:';
$_lang["files_directories"] = 'Los directorios';
$_lang["files_directory_is_empty"] = 'Esta directoria está vacía';
$_lang["files_dirwritable"] = '¿El directorio está escribible?';
$_lang["files_editfile"] = 'Editar el archivo';
$_lang["files_file_type"] = 'El tipo de archivo: ';
$_lang["files_filename"] = 'El nombre de archivo';
$_lang["files_fileoptions"] = 'Las opciones';
$_lang["files_files"] = 'Los archivos';
$_lang["files_filesize"] = 'El tamaño de archivo';
...
$_lang["files_modified"] = 'Fue modificado';
...
$_lang["files_upload_error"] = 'El error';
...
$_lang["friendly_alias_title"] = 'Utilizar lasaliases URL amigables:';
...
$_lang["home"] = 'El cuadro de mando';
$_lang["htmlsnippet"] = 'El trozo (chunk)';
$_lang["htmlsnippets"] = 'Los trozos (chunks)';
$_lang["htmlsnippet_desc"] = 'La descripción';
...
$_lang["htmlsnippet_name"] = '{{ El nombre de trozo (chunk) }}';
...
$_lang["info"] = 'Info';
$_lang["information"] = 'La información';
$_lang["inline"] = 'En linea';
$_lang["insert"] = 'Insertar';
$_lang["maxImageWidth"] = 'El ancho máximo de la imagen';
$_lang["maxImageHeight"] = 'La altura máxima de la imagen';
...
$_lang["thumbWidth"] = 'El ancho máximo de la miniatura';
$_lang["thumbHeight"] = 'La altura máxima de la miniatura';
$_lang["thumbsDir"] = 'La ubicación del directorio de miniaturas';
...
$_lang["thumbWidth_message"] = 'El ancho máximo de la miniatura.';
$_lang["thumbHeight_message"] = 'La altura máxima de la miniatura.';
$_lang["thumbsDir_message"] = 'El nombre del directorio de miniaturas.';
$_lang["jpegQuality_message"] = 'La calidad de compresión de JPEG de miniaturas e imágenes redimensionadas';
$_lang["showHiddenFiles"] = 'Mostrar archivos ocultos en el buscador de archivos';
$_lang["keyword"] = 'La palabra clave';
$_lang["keywords"] = 'Las palabras clave';
...
$_lang["language_title"] = 'El idioma de administrador:';
$_lang["last_update"] = 'La actualización última ';
$_lang["launch_site"] = 'Ver el sitio';
$_lang["license"] = 'La licencia';
$_lang["link_attributes"] = 'Los atributos de enlace';
$_lang["link_attributes_help"] = 'Ingrese los atributos opcionales para un enlace de esta página, tal como "target=" o "rel=".';
...
$_lang["localtime"] = 'El tiempo local';
...
$_lang["locked"] = 'Fue bloqueado';
$_lang["login_allowed_days"] = 'Los días permitidos';
$_lang["login_allowed_days_message"] = 'Seleccione los días en los que este usuario está permitido a iniciar una sesión.';
$_lang["login_allowed_ip"] = 'La dirección IP permitida';
...
<b>Nota: separe los direcciones de IP múltiples con las comas (,)</b>';
...
$_lang["login_homepage"] = 'La página de entrada';
...
$_lang["logout"] = 'Salir';
$_lang["long_title"] = 'El título largo';
$_lang["manage_depends"] = 'Administrar las dependencias';
$_lang["manage_files"] = 'Administrar los archivos';
$_lang["manage_htmlsnippets"] = 'Los trozos (chunks)';
$_lang["manage_metatags"] = 'Administrar las etiquetas META y las palabras claves';
$_lang["manage_modules"] = 'Administrar los módulos';
$_lang["manage_plugins"] = 'Las extensiónes (plugins)';
$_lang["manage_snippets"] = 'Los fragmentos (snippets)';
$_lang["manage_templates"] = 'Las plantillas (templates)';
$_lang["manage_documents"] = 'Los recursos';
$_lang["manage_permission"] = 'Los permisos';
...
$_lang["manager_permissions"] = 'Los permisos de administrador';
$_lang["manager_theme"] = 'El tema de administrador:';
$_lang["manager_theme_message"] = 'Seleccione el tema para el administrador de contenido.';
$_lang["manager_theme_mode"] = 'El esquema de colores:';
...
$_lang["meta_keywords"] = 'Las palabras META clave';
...
$_lang["metatags"] = 'Las etiquetas META';
$_lang["mgr_access_permissions"] = 'Los permisos de acceso de administrador';
$_lang["mgr_login_start"] = 'El inicio de entrada al administrador';
...
<b>Nota: asegúrese que el ID ingresado pertenece a un recurso existente y que ha sido publicado ¡y es accesible por el usuario!</b>';
$_lang["mgrlog_action"] = 'La acción';
$_lang["mgrlog_actionid"] = 'El ID de acción';
...
$_lang["mgrlog_field"] = 'El campo';
$_lang["mgrlog_itemid"] = 'El ID de elemento';
$_lang["mgrlog_itemname"] = 'El nombre de elemento';
$_lang["mgrlog_msg"] = 'El mensaje';
$_lang["mgrlog_noquery"] = 'No se ha ingresado una consulta de búsqueda todavía.';
$_lang["mgrlog_qresults"] = 'Los resultados de consulta';
$_lang["mgrlog_query"] = 'Los registros de consultas';
...
$_lang["mgrlog_results"] = 'La cantidad de resultados';
$_lang["mgrlog_searchlogs"] = 'El registro de búsquedas';
...
$_lang["mgrlog_time"] = 'El tiempo';
$_lang["mgrlog_user"] = 'El usuario';
$_lang["mgrlog_username"] = 'El nombre de usuario';
$_lang["mgrlog_value"] = 'El valor';
$_lang["mgrlog_view"] = 'Ver registros de administrador';
$_lang["module_code"] = 'El código de módulo (php)';
$_lang["module_config"] = 'La configuración de modulo';
$_lang["module_desc"] = 'La descripción';
...
$_lang["module_name"] = 'El nombre del módulo';
...
$_lang["module_resource_title"] = 'Las dependencias del módulo';
$_lang["module_title"] = 'Crear/editar el módulo';
$_lang["module_viewdepend_msg"] = 'Ver los elementos asignados que depende deeste módulo. Haga clic en el botón "Administrar dependencias" para modificar las dependencias';
$_lang["modules"] = 'Los módulos';
$_lang["modx_news"] = 'Los anuncios de noticias de Evolution CMS';
$_lang["modx_news_tab"] = 'Las noticias de Evolution CMS';
$_lang["modx_news_title"] = 'Las Noticias de Evolution CMS';
$_lang["modx_security_notices"] = 'Las notas de seguridad de Evolution CMS';
$_lang["modx_version"] = 'La versión de Evolution CMS';
$_lang["monday"] = 'Lunes';
$_lang["move"] = 'Mover';
...
$_lang["name"] = 'El nombre de usuario';
$_lang["new_category"] = 'La categoría nueva';
$_lang["new_file_permissions_message"] = 'Al cargar un nuevo archivo en el administrador de archivos, el administrador de archivos intentará cambiar los permisos del archivo a los ingresados en esta configuración. Es posible que esto no funcione en algunas configuraciones, como IIS, en cuyo caso deberá cambiar manualmente los permisos.';
$_lang["new_file_permissions_title"] = 'Los permisos del archivo nuevo';
...
$_lang["new_folder_permissions_title"] = 'Los permisos de la carpeta nueva';
$_lang["new_permission"] = 'El permiso nuevo';
$_lang["new_htmlsnippet"] = 'El trozo (chunk) nuevo';
$_lang["new_keyword"] = 'Añadir una palabra clave nueva:';
$_lang["new_module"] = 'El módulo nuevo';
$_lang["new_parent"] = 'El padre nuevo';
$_lang["new_plugin"] = 'La extensión (plugin) nueva';
$_lang["new_role"] = 'Crear un rol nuevo';
$_lang["new_snippet"] = 'El fragmento (snippet) nuevo';
$_lang["new_template"] = 'La pantilla nueva';
$_lang["new_tmplvars"] = 'La variable de pantilla (TV) nueva';
$_lang["new_user"] = 'El usuario nuevo';
$_lang["new_web_user"] = 'El usuario web nuevo ';
$_lang["new_resource"] = 'El recurso nuevo';
$_lang["no"] = 'No';
...
$_lang["nologentries_title"] = 'La cantidad de eventos en registro:';
$_lang["none"] = 'Ninguno';
...
$_lang["onlineusers_title"] = 'Los usuarios en línea';
$_lang["onlineusers_user"] = 'El nombre de usuario';
$_lang["onlineusers_userid"] = 'ID de usuario';
$_lang["optimize_table"] = 'Haga clic aquí para optimizar esta tabla';
$_lang["page_data_alias"] = 'El alias URL';
...
$_lang["page_data_changes"] = 'Los cambios';
$_lang["page_data_contentType"] = 'El tipo de contenido';
...
$_lang["page_data_created"] = 'Fue creado';
$_lang["page_data_edited"] = 'Fue editado';
...
$_lang["page_data_mgr_access"] = 'El acceso de administrador';
$_lang["page_data_notcached"] = 'Este recurso (todavía) no ha sido cacheado.';
$_lang["page_data_publishdate"] = 'La fecha de publicación';
...
$_lang["page_data_published"] = 'Fue publicado';
...
$_lang["page_data_title"] = 'Los datos de página';
$_lang["page_data_unpublishdate"] = 'La fecha de despublicación';
...
$_lang["page_data_web_access"] = 'El acceso web';
$_lang["pagetitle"] = 'El título de recurso';
...
$_lang["password"] = 'La contraseña';
$_lang["password_change_request"] = 'La solicitud de cambio de contraseña';
...
$_lang["plugin"] = 'La extensión (plugin)';
$_lang["plugins"] = 'Las extensiónes (plugins)';
$_lang["plugin_code"] = 'El código de extensión (plugin) (php)';
$_lang["plugin_config"] = 'La configuración de extensión (plugin)';
$_lang["plugin_desc"] = 'La descripción';
$_lang["plugin_disabled"] = 'La extensión (plugin) está deshabilitado';
...
$_lang["plugin_name"] = 'El nombre de la extensión (plugin)';
...
$_lang["plugin_priority_title"] = 'El orden de ejecución de extensiónes (plugins)';
...
$_lang["publish_date"] = 'La fecha de publicación';
...
$_lang["rb_base_dir_title"] = 'La dirección de la base de archivos:';
...
$_lang["recent_docs"] = 'Los recursos recientes';
...
$_lang["references"] = 'Las referencias';
...
$_lang["release_date"] = 'La fecha de lanzamiento';
...
$_lang["resource"] = 'El recurso';
$_lang["resource_alias"] = 'El alias URL';
...
$_lang["resource_content"] = 'El contenido de recurso';
$_lang["resource_description"] = 'La descripción';
...
$_lang["resource_opt_contentdispo"] = 'La disposición de contenido';
...
$_lang["resource_opt_folder"] = 'El contenedor';
...
$_lang["resource_opt_menu_index"] = 'El índice de menú';
...
$_lang["resource_opt_menu_title"] = 'El título de menú';
...
$_lang["resource_overview"] = 'La vista general de recurso';
$_lang["resource_parent"] = 'El principal de recurso';
...
$_lang["resource_setting"] = 'La configuración de recurso';
$_lang["resource_summary"] = 'El resumen (introtext)';
$_lang["resource_summary_help"] = 'Escribe un resumen corto de recurso';
$_lang["resource_title"] = 'El título';
...
$_lang["resource_to_be_moved"] = 'El recurso para mover';
$_lang["resource_type"] = 'El tipo de recurso';
...
$_lang["resource_type_weblink"] = 'El enlace web';
$_lang["resource_type_webpage"] = 'La página web';
...
$_lang["resources_in_container"] = 'los recursos en este contenedor';
$_lang["resources_in_container_no"] = 'Este contenedor no tiene recursos secundarios.';
$_lang["role"] = 'El rol';
$_lang["role_about"] = 'Ver la página "sobre sistema"';
...
$_lang["role_change_resourcetype"] = 'El cambio del tipo de recurso';
$_lang["role_chunk_management"] = 'La administración de trozos (chunks)';
$_lang["role_config_management"] = 'La administración de configuración';
$_lang["role_content_management"] = 'La administración de contenido';
...
$_lang["role_file_management"] = 'La gestión de archivos';
...
$_lang["role_plugin_management"] = 'La administración de extensiónes (plugins)';
$_lang["role_publish_doc"] = 'Publicar los recursos';
$_lang["role_remove_locks"] = 'Remover los bloqueos';
$_lang["role_role_management"] = 'Los roles';
...
$_lang["role_snippet_management"] = 'La administración de fragmentos (snippets)';
$_lang["role_template_management"] = 'La administración de plantillas (templates) de sitio';
$_lang["role_title"] = 'Crear/editar un rol';
$_lang["role_udperms"] = 'La administración de permisos';
$_lang["role_user_management"] = 'La administración de usuarios';
...
$_lang["role_web_user_management"] = 'La administración de usuarios web';
...
$_lang["search_results"] = 'Los resultados de búsqueda';
$_lang["search_results_returned_desc"] = 'La descripción';
...
$_lang["search_results_returned_title"] = 'El título';
$_lang["search_view_docdata"] = 'Ver este artículo';
$_lang["security"] = 'Los usuarios';
$_lang["security_notices_tab"] = 'Las notas de seguridad';
$_lang["security_notices_title"] = 'Las notas de seguridad';
$_lang["select_date"] = 'Seleccione usted una fecha';
$_lang["send"] = 'Enviar';
...
$_lang["server_protocol_title"] = 'El tipo de servidor:';
...
$_lang["serveroffset_title"] = 'La hora desplazamiento del servidor:';
$_lang["servertime"] = 'La hora del servidor';
...
$_lang["settings_config"] = 'La configuración';
$_lang["settings_dependencies"] = 'Las dependencias';
$_lang["settings_events"] = 'Los eventos de sistema';
...
$_lang["settings_misc"] = 'El administrador de archivos';
$_lang["settings_security"] = 'La seguridad';
$_lang["settings_KC"] = 'El explorador de archivos';
$_lang["settings_page_settings"] = 'Los ajustes';
$_lang["settings_photo"] = 'La fotografía';
$_lang["settings_properties"] = 'Las opciónes';
...
$_lang["settings_templvars"] = 'Las variables de plantilla (TV)';
$_lang["settings_title"] = 'La configuración de sistema';
$_lang["settings_ui"] = 'El interfaz y las características';
$_lang["settings_users"] = 'El usuario';
$_lang["settings_email_templates"] = 'El correo electrónico y las plantillas';
...
$_lang["signupemail_title"] = 'El correo electrónico de inicio de sesión:';
$_lang["site"] = 'El sitio';
$_lang["site_schedule"] = 'El horario';
$_lang["sitename_message"] = 'Ingrese usted el nombre de sitio aquí.';
$_lang["sitename_title"] = 'El nombre de sitio:';
$_lang["sitestart_message"] = 'Ingresa el ID de recurso que quiere usted usar como la página principal aquí.
<b>Nota: Asegúrese que el ID ingresado pertenece a un recurso existente ¡y que ha sido publicado!</b>';
$_lang["sitestart_title"] = 'La página de inicio de sitio:';
...
$_lang["sitestatus_title"] = 'El estado de sitio:';
$_lang["siteunavailable_message"] = 'El mensaje para mostrar cuando el sitio está fuera de línea o si ocurre un error.
<b>Nota: Este mensaje solo se mostrará si la opción de página \'Sitio no disponible\' no está configurada.</b>';
...
$_lang["snippet"] = 'El fragmento (snippet)';
$_lang["snippets"] = 'Los fragmentos (snippets)';
$_lang["snippet_code"] = 'El código de fragmento (snippet) (php)';
$_lang["snippet_desc"] = 'La descripción';
...
$_lang["snippet_name"] = '[[ El nombre de fragmento ]]';
...
$_lang["sysinfo_userid"] = 'El usuario';
$_lang["system"] = 'El sistema';
...
$_lang["table_prefix"] = 'El prefijo de tabla';
$_lang["tag"] = 'La etiqueta';
$_lang["template"] = 'La plantilla (template)';
$_lang["templates"] = 'Las plantillas (templates)';
$_lang["template_assignedtv_tab"] = 'Las variables de plantilla (TV) asignadas';
$_lang["template_code"] = 'El código de plantilla (html)';
$_lang["template_desc"] = 'La descripción';
...
$_lang["template_name"] = 'El nombre de plantilla (template)';
...
$_lang["template_assigned_blade_file"] = 'El archivo de tipo Blade correspondiente';
...
$_lang["tmplvar_tmpl_access"] = 'El acceso a la plantilla';
$_lang["tmplvar_tmpl_access_msg"] = 'Seleccione las plantillas que tienen el permiso acceder/procesar esta variable';
$_lang["tmplvar"] = 'La variable de plantilla (TV)';
$_lang["tmplvars"] = 'Las variables de plantilla (TV)';
$_lang["tmplvars_binding_msg"] = 'Este campo soporta vínculos de fuente de datos usando comandos empezados con @';
$_lang["tmplvars_caption"] = 'El subtítulo';
$_lang["tmplvars_default"] = 'El valor prefijado';
$_lang["tmplvars_description"] = 'La descripción';
$_lang["tmplvars_elements"] = 'Los valores de opción de ingreso';
$_lang["tmplvars_inherited"] = 'El valor heredado';
...
$_lang["tmplvars_name"] = '[* El nombre de variable *]';
$_lang["tmplvars_novars"] = 'No se encontraron las variables de plantilla (TV)';
$_lang["tmplvars_rank"] = 'El orden de clasificación';
...
$_lang["tmplvars_type"] = 'El tipo de entrada';
$_lang["tmplvars_widget"] = 'El widget';
$_lang["tmplvars_widget_prop"] = 'Las propiedades de widget';
$_lang["to"] = 'a';
$_lang["toggle_fullscreen"] = 'Alternar la pantalla completa';
$_lang["tools"] = 'Las herramientas';
...
$_lang["tv"] = 'La variable de plantilla (TV)';
$_lang["type"] = 'El tipo';
...
$_lang["unauthorizedpage_title"] = 'La página para no autorizados:';
...
$_lang["unpublish_date"] = 'La fecha de despublicación';
$_lang["unpublish_events"] = 'Despublicar los eventos';
$_lang["unpublish_resource"] = 'Despublicar el recurso';
$_lang["untitled_resource"] = 'El recurso sin título';
$_lang["untitled_weblink"] = 'El enlace web sin título';
...
<b>Nota: ¡Los archivos grandes pueden tardar mucho en cargarse!</b>';
$_lang["upload_maxsize_title"] = 'El tamaño máximo de cargar';
...
$_lang["uploadable_files_title"] = 'Los tipos de archivos que se pueden cargar:';
...
$_lang["uploadable_flash_title"] = 'Los tipos de archivos flash que se pueden cargar:';
...
$_lang["uploadable_images_title"] = 'Los tipos de Imágenes que se pueden cargar:';
...
$_lang["uploadable_media_title"] = 'Los tipos de archivo media que se pueden cargar:';
...
$_lang["user_email"] = 'La dirección de correo electrónico';
$_lang["user_failedlogincount"] = 'Los ingresos fallidos';
$_lang["user_fax"] = 'El fax';
$_lang["user_female"] = 'Femenino';
$_lang["user_full_name"] = 'El nombre completo';
$_lang["user_first_name"] = 'El nombre de pila';
$_lang["user_last_name"] = 'El apellido';
$_lang["user_middle_name"] = 'El nombre segundo';
$_lang["user_gender"] = 'El género';
$_lang["user_is_blocked"] = '¡Este usuario está bloqueado!';
$_lang["user_logincount"] = 'El número de ingresos';
...
$_lang["user_mobile"] = 'El móvil';
$_lang["user_phone"] = 'El teléfono';
$_lang["user_photo"] = 'La foto de usuario';
...
$_lang["user_role"] = 'El rol de usuario';
...
$_lang["user_verification"] = 'El usuario está verificado';
$_lang["user_zip"] = 'El código postal';
$_lang["username"] = 'El nombre de usuario';
$_lang["username_unique"] = '¡El nombre de usuario ya está en uso!';
$_lang["users"] = 'Los usuarios';
...
$_lang["valid_hostnames_title"] = 'Los nombres de host válidos';
...
$_lang["version"] = 'La versión';
$_lang["view"] = 'Ver';
$_lang["view_child_resources_in_container"] = 'Ver secundarios';
$_lang["view_log"] = 'Ver el registro';
$_lang["view_logging"] = 'Las acciones de administración';
$_lang["view_sysinfo"] = 'La información de sistema';
...
$_lang["web_access_permissions"] = 'Los permisos de acceso web';
$_lang["web_access_permissions_user_groups"] = 'El grupo de usuarios web:';
$_lang["web_permissions"] = 'Los permisos web';
...
$_lang["web_user_management_title"] = 'Los usuarios web';
$_lang["web_user_management_select_role"] = 'Todos los roles';
$_lang["web_user_title"] = 'Crear/editar un usuario web';
$_lang["web_users"] = 'Los usuarios web';
$_lang["weblink"] = 'El enlace web';
...
$_lang["webpwdreminder_title"] = 'El correo electrónico de recordatorio';
...
$_lang["websignupemail_title"] = 'El correo electrónico de registración';
...
$_lang["which_editor_title"] = 'El editor para usar:';
...
$_lang["yourinfo_total_logins"] = 'El número total de ingresos:';
$_lang["yourinfo_username"] = 'Está ingresado como:';

$_lang["a17_error_reporting_title"] = 'La nivel de detección de errores de PHP';
...
$_lang["pwd_hash_algo_title"] = 'El algoritmo hash';
$_lang["pwd_hash_algo_message"] = 'El algoritmo hash de contraseña.';
...
$_lang["bkmgr_run_sql_result"] = 'El resulto';
...
$_lang["bkmgr_snapshot_list_title"] = 'La lista de instantáneas';
...
$_lang["files.dynamic.php1"] = 'El archivo nuevo de texto';
...
$_lang['email_method_title'] = 'Los metodos de sendmail';
$_lang['email_method_mail'] = 'La función mail() de PHP';
$_lang['email_method_smtp'] = 'El servidor SMTP';
$_lang['smtp_auth_title'] = 'SMTP-AUTH';
$_lang['smtp_autotls_title'] = 'SMTPAutoTLS';
$_lang['smtp_host_title'] = 'El hospedador SMTP';
$_lang['smtp_secure_title'] = 'SMTP cifrado';
$_lang['smtp_username_title'] = 'El usuario SMTP';
$_lang['smtp_password_title'] = 'La contraseña SMTP';
$_lang['smtp_port_title'] = 'El puerto SMTP';
...
$_lang['resource_opt_is_published'] = 'Está publicado';
$_lang["docid_incrmnt_method_title"] = 'El método de incremento del ID de recursos';
...
$_lang["enable_cache_title"] = 'El caché de recursos';
...
$_lang["cache_type_title"] = 'El tipo de caché de recursos';
$_lang["cache_type_1"] = 'El caché se basa solo en el ID de recurso (estándar)';
$_lang["cache_type_2"] = 'El caché se basa en los parámetros el ID de recurso y $_GET';
...
$_lang["aliaslistingfolder_title"] = 'Use AliasListing solo para las carpetas';
$_lang["full_aliaslisting_title"] = 'Deshabilitar AliasListing para todos los recursos';
$_lang["aliaslistingfolder_message"] = 'Reduce el consumo de memoria cuando hay la cantidad grande de recursos';
...
$_lang["user_street"] = 'La calle';
$_lang["user_city"] = 'La ciudad';
...
$_lang["which_browser_default_title"] = "El explorador de archivos por el defecto";
...
$_lang['downloads'] = "Las descargas";
$_lang["previous_releases"] = "Las lanzamientos anteriores";
$_lang["extras"] = "Las extras";
...
$_lang["lock_element_type_1"] = "La plantilla";
$_lang["lock_element_type_2"] = "El variable de plantilla (TV)";
$_lang["lock_element_type_3"] = "El trozo (chunk)";
$_lang["lock_element_type_4"] = "El fragmento (snippet)";
$_lang["lock_element_type_5"] = "La extensión (plugin)";
$_lang["lock_element_type_6"] = "El módulo";
$_lang["lock_element_type_7"] = "El recurso";
$_lang["lock_element_type_8"] = "El rol";
...
$_lang["safe_functions_at_eval_title"] = "Las funciones permitidas para ejecutar";
...
$_lang["cm_category_name"] = "El nombre de categoría";
$_lang["cm_category_position"] = "La posición de categoría";
...
$_lang["cm_assigned_elements"] = "Los elementos asignados";
...
$_lang["cm_global_messages"] = "Los messages globales";
...
$_lang["cm_translation"] = "La traducción";
$_lang["cm_translations"] = "Las traducciones";
...
$_lang["cm_native_phrase"] = "La frase nativo";

$_lang["btn_view_options"] = 'Ver las opciones';
$_lang["view_options_msg"] = 'La visualización y la lista de elementos se pueden personalizar a través del botón "Ver opciones". Las configuraciones se guardan y restauran por navegador utilizando el almacenamiento local de HTML5.';
$_lang["viewopts_title"] = 'Ver las opciones';
$_lang["viewopts_cb_buttons"] = 'Los botónes';
$_lang["viewopts_cb_descriptions"] = 'Las descripciónes';
$_lang["viewopts_cb_icons"] = 'Los iconos';
$_lang["viewopts_radio_list"] = 'La lista';
$_lang["viewopts_radio_inline"] = 'En línea';
$_lang["viewopts_radio_flex"] = 'Flexionar';
$_lang["viewopts_fontsize"] = 'El tamaño de letras';
...
$_lang['login_logo_message'] = 'El ancho recomendado de la imágen: 360px y de tipo PNG';
