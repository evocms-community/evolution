...
$_lang["checking_pgsql_version"] = 'Controllo della versione di PostgreSQL: ';
...
$_lang["connection_screen_database_type"] = 'Tipo di Database:';
...
$_lang["modx_footer1"] = '&copy; 2005-[+current_year+] <a href="https://evo-cms.com/" target="_blank" style="color: green; text-decoration:underline">EVO</a> Content Management Framework (CMF) project.  Tutti i diritti riservati. EVO &eacute; sotto la licenza GNU GPL.';
...
$_lang["mysql_old_version"] = 'Quando si usa una versione precedente alla 5.7.6 l\'engine sarà MyISAM, le versioni successive useranno InnoDB.<br> Vi consigliamo di usare una versione aggiornata di MySQL.';
...
$_lang["visit_forum"] = ', consultate i <a href="https://forum.evo-cms.com/" target="_blank">Forums EVO</a>.';
