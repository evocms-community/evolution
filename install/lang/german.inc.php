...
$_lang["cant_write_config_file"] = 'EVO konnte die Konfigurationsdatei nicht erstellen. Bitte fügen Sie folgendes in eine leere Datei ein:';
$_lang["cant_write_config_file_note"] = 'Sobald dieser Vorgang beendet ist, können Sie sich im EVO-Manager anmelden unter http://ihredomain.de/[+MGR_DIR+]/.';
...
$_lang["checking_iconv"] = 'Überprüfung, ob die Erweiterung <span class="mono">iconv</span> verfügbar ist:';
$_lang["checking_iconv_note"] = 'Es ist wichtig, die Erweiterung iconv zu installieren/aktivieren. Bitte kontaktieren Sie Ihren Provider, wenn Sie nicht wissen was zu tun ist.';
...
$_lang["checking_registerglobals_note"] = 'Diese Konfiguration macht Ihre Website angreifbarer für Cross Site Scripting (XSS) Attacken. Sie sollten mit Ihrem Provider sprechen, ob diese Einstellung geändert werden kann. Es gibt normalerweise drei Möglichkeiten: Ändern der globalen php.ini, Hinzufügen von Regeln zu der .htaccess-Datei im Root-Verzeichnis der EVO-Installation oder durch Hinzufügen einer angepassten php.ini in jedem Verzeichnis Ihrer EVO-Installation. Sie können EVO trotzdem installieren, aber Sie müssen sich den möglichen Sicherheitsrisiken bewusst sein.';
...
$_lang["default_language_description"] = 'Das ist die voreingestellte Sprache die im EVO-Manager (dem EVO-Adminbereich) verwendet wird.';
...
$_lang["help_title"] = 'Unterstützung zur Installation finden Sie in den EVO-Foren';
...
$_lang["installation_note"] = '<b>Achtung:</b> Nach dem Anmelden im EVO-Manager sollten Sie die Konfigurationseinstellungen unter <b>Werkzeuge -> Konfiguration</b> vornehmen und speichern bevor Sie Ihre Seite aufrufen.';
...
$_lang["modx_footer1"] = '&copy; 2005-[+current_year+] <a href="http://modx.com/" target="_blank" style="color: green; text-decoration:underline">EVO</a> Content Management Framework (CMF) Projekt. Alle Rechte vorbehalten. EVO ist lizensiert gemäß GNU GPL.';
$_lang["modx_footer2"] = 'EVO ist freie Software.  Wir ermutigen Sie, kreativ zu sein und EVO so zu nutzen wie es Ihnen am besten passt. Stellen Sie nur sicher, dass Sie bei Veränderungen des Quellcodes und der Weiterverbreitung der modifizierten EVO-Version den Quelltext frei zugänglich belassen!';
$_lang["modx_install"] = 'EVO &raquo; Installation';
$_lang["modx_requires_php"] = ', und EVO benötigt PHP [+min_version+] oder höher';
...
$_lang["remove_install_folder_manual"] = 'Bitte denken Sie daran den Ordner <b>install</b> zu löschen bevor Sie sich im EVO-Manager anmelden.';
...
$_lang["setup_couldnt_install"] = 'EVO konnte die Tabellen in der gewählten Datenbank nicht anlegen/ändern.';
...
$_lang['status_failed_mysqli'] = 'Fehler - mysqli-Erweiterung für PHP ist nicht installiert!';
...
$_lang["strict_mode_error"] = 'Bestimmte EVO-Funktionen funktionieren nicht korrekt solange „STRICT_TRANS_TABLES sql_mode“ aktiviert ist. Sie können den MySQL-Modus ändern, in dem Sie die Datei „my.cnf“ anpassen oder Ihren Server-Administrator kontaktieren.';
$_lang["summary_setup_check"] = 'Es wird überprüft, ob alles für die Installation bereit ist.';
$_lang["system_configuration"] = 'EVO-Konfiguration';
$_lang["system_configuration_validate_referer_description"] = 'Die Aktivierung der Einstellung <strong>HTTP_REFERER-Header überprüfen?</strong> wird empfohlen. Diese Einstellung kann ihre Website vor CSFR-Attacken (Cross Site Request Forgery) schützen. Bei manchen Server Konfigurationen kann nach dem Aktivieren der EVO Manager nicht mehr erreichbar sein.';
...
$_lang['tvs'] = 'Vorlagenvariablen';
$_lang["unable_install_chunk"] = 'Chunk kann nicht installiert werden. Datei';
$_lang["unable_install_module"] = 'Modul kann nicht installiert werden. Datei';
$_lang["unable_install_plugin"] = 'Plugin kann nicht installiert werden. Datei';
$_lang["unable_install_snippet"] = 'Snippet kann nicht installiert werden. Datei';
$_lang["unable_install_template"] = 'Vorlage kann nicht installiert werden. Datei';
...
$_lang["visit_forum"] = ', besuchen Sie die <a href="http://de.modx.com/forum/" target="_blank">EVO-Foren</a>.';
...
$_lang["welcome_message_welcome"] = 'Willkommen beim EVO-Installationsprogramm.';
