## History
### 1.22.0
* [Enhancement] Turnstile Captcha

### 1.21.0
* [Refactor] Ссылки для активации и проверки аккаунтов можно задавать текстом (для роутов в Evo 3).

### 1.20.0
* [Enhancement] Проверка CSRF-токена (Core).
