...
/** @var EvolutionCMS\Models\SitePlugin $item */
?>
<li>
    <div class="rTable">
        <div class="rTableRow">
            ...
            <div class="mainCell elements_description">
                <span class="rTableRowTitle @if($item->disabled) disabledPlugin @endif">
                    <a class="man_el_name site_plugins" target="main" data-type="site_plugins" data-id="{{ $item->id }}"
                       data-catid="{{ $item->category }}" href="{{ $item->makeUrl('actions.edit') }}">
                    ...
                    @if(evo()->hasPermission('delete_plugin'))
                        <li>
                            <a href="{{ $item->makeUrl('actions.delete') }}" target="main"
                               ...
                               onclick="return confirm(`{{ __('global.confirm_delete_plugin') }}`)">
