<div class="tab-page {{ $tabPageName }}" id="{{ $tabIndexPageName }}">
    <h2 class="tab">
        <a href="?a=76&tab={{ $index }}"><i
                class="{{ $_style['icon_code'] }}"></i>{{ ManagerTheme::getLexicon('snippets') }}</a>
    </h2>
    <script>
            ...
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-btn">
                    <a class="btn btn-success" target="main"
                        href="{{ (new EvolutionCMS\Models\SiteSnippet())->makeUrl('actions.new') }}">
                ...
                @component('manager::partials.panelCollapse', [
                    ...
                    <ul class="elements">
                        @foreach ($outCategory as $item)
                            @include(
                                'manager::page.resources.elements.snippet',
