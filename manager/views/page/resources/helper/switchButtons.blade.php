<form id="switchForm_{{ $id }}" class="form-group form-inline switchForm"
    ...
    <div class="form-group mr-3">
        <div class="form-check mr-sm-2">
            ...
            <label class="form-check-label"
                for="radio_list_{{ $id }}">{{ __('global.viewopts_radio_list') }}</label>
        </div>
        <div class="form-check mr-sm-2">
            <input class="form-check-input" id="radio_inline_{{ $id }}" type="radio" name="view"
                value="inline" />
            <label class="form-check-label"
                for="radio_inline_{{ $id }}">{{ __('global.viewopts_radio_inline') }}</label>
        </div>
        <div class="form-check mr-sm-2">
            <input class="form-check-input" id="radio_flex_{{ $id }}" type="radio" name="view"
                value="flex" />
            <label class="form-check-label mr-2"
                for="radio_flex_{{ $id }}">{{ __('global.viewopts_radio_flex') }}:</label>
    ...
    <div class="form-group mr-3">
        <div class="form-check mr-sm-2">
            <label class="form-check-label mr-2"
                for="fontsize_{{ $id }}">{{ __('global.viewopts_fontsize') }}:</label>
    ...
    <div class="form-group mr-3">
        <div class="form-check mr-sm-2">
            <input class="form-check-input cb_all" id="cb_alltabs_{{ $id }}" type="checkbox" name="cb_all"
                value="all" />
            <label class="form-check-label"
                for="cb_alltabs_{{ $id }}">{{ __('global.viewopts_cb_alltabs') }}</label>
        </div>
    </div>

    <div class="form-group mr-3">
        <div class="optionsLeft optionsReset">
            <a href="javascript:;" class="btn btn-danger btn-sm btn_reset">{{ __('global.reset') }}</a>
        </div>
    </div>
</form>
