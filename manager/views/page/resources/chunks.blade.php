...
<div class="tab-page {{ $tabPageName }}" id="{{ $tabIndexPageName }}">
    <h2 class="tab">
        <a href="?a=76&tab={{ $index }}"><i
                    class="{{ ManagerTheme::getStyle('icon_chunk') }}"></i>{{ __('global.htmlsnippets') }}</a>
    </h2>
    <script>
    ...
    <div id="{{ $tabIndexPageName }}-info" class="msg-container" style="display:none">
        <div class="element-edit-message-tab">{!! __('global.htmlsnippet_management_msg') !!}</div>
            ...
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-btn">
                    <a class="btn btn-success" target="main"
                       href="{{ (new SiteHtmlsnippet())->makeUrl('actions.new') }}">
                        <i class="{{ ManagerTheme::getStyle('icon_add') }}"></i>
                        <span>{{ __('global.new_htmlsnippet') }}</span>
                    </a>
                ...
                @component('manager::partials.panelCollapse', [
                    ...
                    <ul class="elements">
                        @foreach ($outCategory as $item)
                            @include(
                                'manager::page.resources.elements.chunk',
