...
@section('content')
    ...
    <form name="logging" method="post" class="form-group">
        @csrf
        <h1>
            <i class="{{ ManagerTheme::getStyle('icon_user_secret') }}"></i>{{ __('global.mgrlog_view') }}<i
                class="fa fa-question-circle help"></i>
        </h1>

        <div class="container element-edit-message">
            <div class="alert alert-info">{!! __('global.mgrlog_query_msg') !!}</div>
        </div>

        <div class="tab-page">
            <div class="container container-body">
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_user') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                        <select name="searchuser" class="form-control">
                            <option value="0">{{ __('global.mgrlog_anyall') }}</option>
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_action') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_itemid') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_itemname') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_msg') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_datefr') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                        <div class="input-group">
                            ...
                            <i onClick="document.logging.datefrom.value=''; return true;"
                                ...
                                title="{{ __('global.remove_date') }}"></i>
                        </div>
                    </div>
                </div>

                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_dateto') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                        <div class="input-group">
                ...
                <div class="row form-row">
                    <div class="col-5 col-md-3 col-lg-2">{{ __('global.mgrlog_results') }}</div>
                    <div class="col-5 col-md-4 col-lg-3">
                ...
                <div class="row form-row">
                    <button type="submit" class="btn btn-success"><i class="{{ ManagerTheme::getStyle('icon_search') }}"></i>
                        {{ __('global.mgrlog_searchlogs') }}</button>
    ...
    <div class="navbar">
        <h1><i class="fas fa-th-list"></i> {{ __('global.mgrlog_qresults') }}</h1>
    </div>
