                            ...
                            <table class="table data nowrap">
                                ...
                                <tbody>
                                    @foreach($list as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><a href="{{ $_GET['list'] == 'users' ? manager_route('edit_user', ['id' => $item->getKey()]) : manager_route('edit_document', ['id' => $item->getKey()]) }}"target="main">{{ $_GET['list'] == 'users' ? $item->username : $item->pagetitle }}</a></td>
