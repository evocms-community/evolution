                    ...
                    <div class="col-md-9 col-lg-10">
                        <select name="templateid">
                            @foreach ($templates as $template)
                                <option value="{{ $template['value'] }}"{{ $template['selected'] }}>{{ $template['title'] }}
                                </option>
                            @endforeach
                        </select>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="40" class="sortable">
                                        {{ ManagerTheme::getLexicon('search_results_returned_id') }}</th>
                                    <th width="40"></th>
                                    <th class="sortable">{{ ManagerTheme::getLexicon('search_results_returned_title') }}
                                    </th>
                                    <th class="sortable">{{ ManagerTheme::getLexicon('search_results_returned_desc') }}
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <a href="index.php?a=3&id={{ $row['id'] }}"
                                                title="{{ ManagerTheme::getLexicon('search_view_docdata') }}">
