...
$_module_params = [
    ...
    'inc_dir' => realpath(__DIR__) . DIRECTORY_SEPARATOR . 'category_mgr' . DIRECTORY_SEPARATOR . 'inc' .
        DIRECTORY_SEPARATOR,
    'languages_dir' => realpath(__DIR__) . DIRECTORY_SEPARATOR . 'category_mgr' . DIRECTORY_SEPARATOR . 'lang' .
        DIRECTORY_SEPARATOR,
    'views_dir' => realpath(__DIR__) . DIRECTORY_SEPARATOR . 'category_mgr' . DIRECTORY_SEPARATOR . 'skin' .
        DIRECTORY_SEPARATOR,
