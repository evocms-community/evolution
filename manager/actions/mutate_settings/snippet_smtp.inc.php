<table style="border:1px dotted #ccc;padding:8px;">
  ...
  <option value="none" ><?php echo $_lang['no'] ?></option>
   <option value="ssl" <?php if(isset($smtp_secure) && $smtp_secure == 'ssl') echo "selected='selected'"; ?> >SSL</option>
  <option value="tls" <?php if(isset($smtp_secure) && $smtp_secure == 'tls') echo "selected='selected'"; ?> >TLS</option>
 </select>
 <br />
  </td>
  </tr>
