...
?>
                    ...
                    <tr>
                        ...
                        <td><label> <?php if (!isset($usersettings['allowed_days'])) {
    $usersettings['allowed_days'] = '';
}
?>
...
if ($modx->getConfig('use_udperms')) {
    ...
    ?>
            <div class="tab-page" id="tabPermissions">
                ...
                <p><a href="javascript:;" onclick="document.getElementsByName('user_groups[]').forEach(e => e.checked ^= 1) ; return false;"><?php echo $_lang['access_permissions_user_toggle'] ?></a></p>
