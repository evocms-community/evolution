...
$_lang["add_template"] = 'Vorlage hinzufügen';
$_lang["add_tv"] = 'Vorlagenvariablen hinzufügen';
...
$_lang["confirm_delete_template"] = 'Sind Sie sicher, dass Sie dieses Vorlage löschen möchten?';
$_lang["confirm_delete_tmplvars"] = 'Sind Sie sicher, dass Sie diese Vorlagenvariable inklusive der gespeicherten Inhalte löschen möchten?';
...
$_lang["defaulttemplate_title"] = 'Standardvorlage des Systems';
$_lang["defaulttemplate_logic_title"] = 'Automatische Vorlagenzuweisung';
$_lang["defaulttemplate_logic_general_message"] = 'neue Ressourcen erben die folgenden vorlagen. Wird keins gefunden, wird das nächst Höhere vererbt:';
$_lang["defaulttemplate_logic_system_message"] = '<strong>System</strong>: das Standardvorlage des systems.';
$_lang["defaulttemplate_logic_parent_message"] = '<strong>Eltern</strong>: das gleiche Vorlage wie der Eltern-Container.';
$_lang["defaulttemplate_logic_sibling_message"] = '<strong>Nachbar</strong>: das gleiche Vorlage wie andere Ressourcen im selben Container.';
...
$_lang["lock_template"] = 'Vorlage für die Bearbeitung sperren.';
$_lang["lock_template_msg"] = 'Nur Administratoren (Rollen-ID 1) können dieses Vorlage bearbeiten.';
$_lang["lock_tmplvars"] = 'Vorlagenvariable gegen Bearbeitung sperren';
$_lang["lock_tmplvars_msg"] = 'Nur Administratoren (Rollen-ID 1) können diese Vorlagenvariable bearbeiten.';
...
$_lang["manage_templates"] = 'Vorlagen';
...
$_lang['manager_theme_mode_message'] = 'Diese Einstellung wird als "Standard" verwendet und kann vom Manager überschrieben werden, wenn er die Schaltfläche zum Wechseln des Themenfarbmodus im Ressourcenbaum verwendet: <i class="fa fa-lg fa-adjust"></i>';
$_lang['manager_theme_mode_title'] = 'Themenfarbmodus Schalter';
...
$_lang["new_template"] = 'Neue Vorlage';
$_lang["new_tmplvars"] = 'Neue Vorlagenvariable';
...
$_lang["page_data_template"] = 'Vorlage';
...
$_lang["role_create_template"] = 'Neue Vorlagen erstellen';
...
$_lang["role_delete_template"] = 'Vorlagen löschen';
...
$_lang["role_edit_template"] = 'Vorlagen bearbeiten';
...
$_lang["role_save_template"] = 'Vorlage speichern';
...
$_lang["role_template_management"] = 'Vorlagenverwaltung';
...
$_lang["rss_url_security_message"] = 'URL des EVO-Sicherheit-Feeds eintragen.';
...
$_lang["settings_group_tv_message"] = 'Wählen Sie aus ob Vorlagenvariablen in Sektionen oder Tabs (benannt nach TV-Kategorien) gruppiert werden sollen beim Editieren von Ressourcen.';
...
$_lang["tag"] = 'Tag';
$_lang["template"] = 'Vorlage';
$_lang["templates"] = 'Vorlagen';
$_lang["template_assignedtv_tab"] = 'Zugewiesene Vorlagenvariablen';
$_lang["template_code"] = 'Vorlagencode (HTML)';
$_lang["template_desc"] = 'Beschreibung';
$_lang["template_edit_tab"] = 'Vorlage bearbeiten';
$_lang["template_management_msg"] = 'Hier können Sie ein Vorlage wählen, das Sie bearbeiten möchten.';
$_lang["template_msg"] = 'Hier können Sie Vorlagen anlegen und bearbeiten. Die Änderung an einem Vorlage wird nur angezeigt, wenn Sie den Cache leeren. Sie können aber die Vorschaufunktion nutzen, um das Vorlage anzuzeigen.';
$_lang["template_name"] = 'Vorlagenname';
$_lang["template_no_tv"] = 'Dieser Vorlage wurden noch keine Vorlagenvariablen zugewiesen.';
$_lang["template_notassigned_tv"] = 'Diese Vorlagenvariablen können zugewiesen werden.';
$_lang["template_reset_all"] = 'Alle Ressourcen auf das Standardvorlage zurücksetzen';
$_lang["template_reset_specific"] = 'Vorlage nur bei Ressourcen mit dem aktuellen Vorlage „%s“ setzen';
$_lang["template_selectable"] = 'Vorlage ist auswählbar, wenn eine Resource erstellt oder bearbeitet wird.';
$_lang["template_title"] = 'Vorlage erstellen/bearbeiten';
$_lang["template_tv_edit"] = 'Reihenfolge der Vorlagenvariablen bearbeiten';
$_lang["template_tv_edit_message"] = 'Reihenfolge der Vorlagenvariablen für dieses Vorlage durch Drag & Drop sortieren.';
$_lang["template_tv_edit_title"] = 'Reihenfolge Vorlagenvariablen';
$_lang["template_tv_msg"] = 'Liste der Template-Variablen, die diesem Template zugeordnet wurden.';
$_lang["thursday"] = 'Donnerstag';
$_lang["tmplvar_access_msg"] = 'Wählen Sie jene Ressourcen-Gruppen aus, die diese Vorlagenvariable bearbeiten dürfen.';
$_lang["tmplvar_change_template_msg"] = 'Wenn Sie das Vorlage ändern, werden die Vorlagenvariablen neu geladen. Achtung: alle nicht gespeicherten Änderungen gehen hierbei verloren!\n\nSind Sie sicher, dass Sie das Vorlage ändern möchten?';
$_lang["tmplvar_inuse"] = 'Folgende Ressourcen verwenden derzeit diese Vorlagenvariable. Wollen Sie mit dem Löschen fortfahren?';
$_lang["tmplvar_tmpl_access"] = 'Vorlage-Berechtigungen';
$_lang["tmplvar_tmpl_access_msg"] = 'Wählen Sie hier jene Vorlagen aus, die diese Vorlagenvariable verarbeiten dürfen.';
$_lang["tmplvar"] = 'Vorlagenvariable';
$_lang["tmplvars"] = 'Vorlagenvariablen';
...
$_lang["tmplvars_management_msg"] = 'Hier können Sie Ihre Vorlagenvariablen bearbeiten.';
$_lang["tmplvars_msg"] = 'Hier können Sie Vorlagenvariablen erstellen und bearbeiten. Die Vorlagenvariablen müssen für die jeweiligen Vorlagen aktiviert werden, damit Snippets und Ressourcen darauf wie normale Variablen zugreifen können.';
$_lang["tmplvars_name"] = 'Name der Vorlagenvariable';
$_lang["tmplvars_novars"] = 'Keine Vorlagenvariablen gefunden';
$_lang["tmplvars_rank"] = 'Sortierung';
$_lang["tmplvars_rank_edit_message"] = 'Reihenfolge der aufgelisteten Vorlagenvariablen durch Drag&Drop sortieren.';
$_lang["tmplvars_reset_params"] = 'Parameter zurücksetzen';
$_lang["tmplvars_title"] = 'Vorlagenvariable erstellen/bearbeiten';
...
$_lang["enable_filter_message"] = 'Filter ermöglichen es, Inhalte von Tags / TVs innerhalb Ihrer Templates dynamisch zu manipulieren, analog zu PHx. <a href="https://github.com/modxcms/evolution/issues/623" target="ext_help">Mehr Informationen</a>'; // todo: change link to documentation
...
$_lang["enable_at_syntax_message"] = '&lt;@SYNTAX&gt;(atmark syntax) ist eine simple Vorlagensyntax.';
...
$_lang["full_aliaslisting_title"] = 'AliasListing deaktivieren für alle Ressourcen';
...
$_lang["error_parent_deleted"]        = "Fehlgeschlagen, weil die übergeordnete Ressource gelöscht wurde!";
...
$_lang['help_translating_title'] = "Helfen Sie mit, Evolution zu übersetzen";
...
$_lang["lock_element_type_1"] = "Vorlage";
$_lang["lock_element_type_2"] = "Vorlagenvariable";
...
$_lang["iconv_not_available"]     = "Es ist wichtig, die Erweiterung iconv zu installieren/aktivieren. Bitte kontaktieren Sie diesbezüglich Ihren Web-Hosting-Provider oder Administrator, wenn Sie nicht wissen was zu tun ist.";
