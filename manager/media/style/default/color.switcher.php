...
?>
<div class="evocp-box">
    <div class="evocp-icon">
        <i class="evocpicon <?= ManagerTheme::getStyle('icon_brush') ?>" aria-hidden="true"></i>
    </div>
    <div class="evocp-frame">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 data-toggle="collapse" data-target=".bgmcolors">
                    <i class="togglearrow <?= ManagerTheme::getStyle('icon_chevron_down') ?>"
                       aria-hidden="true"></i>
            ...
            <div class="panel-body collapse in bgmcolors">
                ...
                <input type="color" class="color" id="bgmPicker" name="evocpCustombgmColor" value="#cf2626"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body collapse menuColors">
                ...
                <input class="color" type="color" id="menucolorPicker" name="evocpCustommenuColor" value="#cf2626"
                       placeholder="color code...">
            </div>
        </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body collapse menuHColors">
                ...
                <input class="color" type="color" id="menuHcolorPicker" name="evocpCustommenuHColor" value="#cf2626"
                       placeholder="color code...">
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body collapse cpcolors">
                ...
                <input class="color" type="color" id="textcolorPicker" name="textcolorPicker" value="#cf2626"
                       placeholder="color code...">
            </div>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body collapse alinkcolors">
                ...
                <input class="color" type="color" id="linkcolorPicker" name="alinkcolorPicker" value="#cf2626"
                       placeholder="color code...">
            </div>
        </div>
        <hr/>
